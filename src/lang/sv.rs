...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Onix..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Onix fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Onix på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Onix \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Onix \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Onix Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Onix background service", "Behåll Onix i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Onix programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge Onix behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge Onix behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för Onix."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera Onix-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda Onix och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera Onix Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra Onix från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om Onix-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla Onix-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera Onix-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar Onix serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar Onix över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder Onix inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: Onix server OSS inkluderar inte denna funktion."),
