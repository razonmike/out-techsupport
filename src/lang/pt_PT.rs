...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Onix..."),
        ...
        ("install_tip", "Devido ao UAC, o Onix não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Onix no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Onix permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Onix permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Onix use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Onix Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Onix background service", "Manter o serviço Onix em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação Onix, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Onix as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Onix as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Onix em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do Onix"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Onix e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o Onix Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Onix de funcionar corretamente como lado controlado."),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Onix estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Onix"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Onix para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o Onix verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o Onix recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o Onix deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o Onix server OSS não inclui esta funcionalidade."),
