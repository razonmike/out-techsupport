...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("OutTechSupport".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.out-techsupport.ru"];
pub const RS_PUB_KEY: &str = "c9rnlHWKKa6mj6lTtvlVtt3oFSrR65mruhzfvKYp28I=";
